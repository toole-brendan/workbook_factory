...
from sheets._tam_cuts import load_rows
from sheets._tam_layout import RowCursor
from sheets._tam_factor import S_FACTOR
from sheets._tabs import TAB_DEFLATORS
from sheets import _tam_widths as W

_GROUP = "inputs"   # hand-maintained deflator levers sit with the other input tabs
_NCOLS = 4

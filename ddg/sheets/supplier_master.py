...
from sheets._tabs import TAB_SUPPLIER_MASTER
from sheets.naics6_archetype_map import naics_map_cols
from sheets.vendor_archetype_overrides import overrides_cols

...
from sheets._data import tam as _path


def load_grid(name: str) -> list[list[str]]:
    """Full row-major grid of the TAM-side CSV for a logical stem (raw strings)."""
    with _path(name).open(encoding="utf-8", newline="") as fh:

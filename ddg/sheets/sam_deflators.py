...
from sheets._sam_flat import make_flat_sheet
from sheets._sam_fiscal import FY_BIN_KEYS as _FY_ROW_ORDER
from sheets._tabs import TAB_SAM_DEFLATORS
...
DEFLATORS, deflators_cols = make_flat_sheet(
    tab=TAB_SAM_DEFLATORS, group="inputs",
...
def deflator_factor_cell(fy_key: str) -> str:
    ...
    return f"'{TAB_SAM_DEFLATORS}'!${_FCOL}${_FFIRST + _FY_ROW_ORDER.index(fy_key)}"
